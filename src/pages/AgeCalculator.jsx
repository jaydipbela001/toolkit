      ...
      <div className="ac-container">
        ...
        <div className="ac-card">
          ...
          <div className="ac-mode-toggle">
            <button
              type="button"
              className={`ac-mode-btn ${inputMode === 'calendar' ? 'ac-mode-active' : ''}`}
            ...
            <button
              type="button"
              className={`ac-mode-btn ${inputMode === 'manual' ? 'ac-mode-active' : ''}`}
          ...
          <div className="ac-input-section">
            ...
            {/* Show selected date preview when calendar mode */}
              ...
              <div className="ac-info-item">
                ...
                <div>
                  ...
                  <div className="ac-info-value">
                    {age.daysUntilBirthday === 0 ? '🎉 Today!' : `in ${age.daysUntilBirthday} days`}
                  </div>
                </div>
              </div>
              <div className="ac-info-item">
